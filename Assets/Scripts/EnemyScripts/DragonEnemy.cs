...
public class DragonEnemy : MonoBehaviour
{
    ...
    private int MaxHp = AllEnemy.DragonEnemy.MaxHP;
    ...
    void Start()
    {
        ...
        CanMove = true;
        CanAttack = false;
        Speed = AllEnemy.DragonEnemy.Speed;
        ATK = AllEnemy.DragonEnemy.ATK;
        AttackCD = AllEnemy.DragonEnemy.CD;
        AttackCDisOk = true;
